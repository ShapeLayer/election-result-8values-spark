...
21대 총선에서 더불어민주당은 대구-경북 지역의 모든 지역구에 후보자를 내어 보수성향 광역시도에서는 지역구 투표에서도 범진보계 표를 획득할 수 있었으나, 미래통합당을 포함한 범보수계는 호남 지역에 많은 후보자를 내지 않았다. @future-honam-candidate #footnote[심지어 더불어민주당 지역구 후보는 정의당 후보와 표가 갈려 14.7% 표를 획득한 경주시를 제외하고, 대구-경북 지역의 모든 선거구에서 15% 이상의 표를 얻어 선거비 보전을 받았다.]

이로 인하여 호남지역의 진보 성향은 대구-경북 지역의 보수 성향에 비해 다소 두드러지게 표현되었다.
...
#figure(
  ...
  #table(
    ...
    [
      ...
      만약 충분한 평가 근거가 없다면, 그 정당은 평가에서 제외하라.
